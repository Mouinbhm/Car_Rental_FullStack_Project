...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="max-w-2xl mx-auto text-center">
                        <h1 
                            ...
                            data-aos-delay="100"
                        >
                            Premium Car Rental in <span className="text-yellow-400">Tunisia</span>
                        </h1>
                        <p 
                            ...
                            data-aos-delay="200"
                        >
                            Explore Tunisia in comfort with our wide selection of vehicles at competitive prices
                        </p>
                        <div 
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-3 text-center">Best Prices</h3>
                        ...
                        >
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-3 text-center">New Fleet</h3>
                            <p className="text-gray-600 text-center">
                                Well-maintained, late-model vehicles with comprehensive insurance.
                            </p>
                        </div>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            />
                            <div className="p-6">
                                <h3 className="text-xl font-bold text-gray-900 mb-2">Economy Cars</h3>
                                <p className="text-gray-600 mb-4">Perfect for city driving and saving on fuel</p>
                                <div className="flex justify-between items-center">
                                    <span className="text-blue-600 font-bold">From 120 TND/day</span>
                                    <Link to="/cars/economy" className="text-blue-600 hover:underline">View Options</Link>
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            />
                            <div className="p-6">
                                <h3 className="text-xl font-bold text-gray-900 mb-2">SUVs & 4x4s</h3>
                                <p className="text-gray-600 mb-4">Ideal for family trips and off-road adventures</p>
                                <div className="flex justify-between items-center">
                                    <span className="text-blue-600 font-bold">From 250 TND/day</span>
                                    <Link to="/cars/suv" className="text-blue-600 hover:underline">View Options</Link>
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            />
                            <div className="p-6">
                                <h3 className="text-xl font-bold text-gray-900 mb-2">Luxury Vehicles</h3>
                                <p className="text-gray-600 mb-4">Travel in style with our premium selection</p>
                                <div className="flex justify-between items-center">
                                    <span className="text-blue-600 font-bold">From 400 TND/day</span>
                                    <Link to="/cars/luxury" className="text-blue-600 hover:underline">View Options</Link>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {/* How It Works */}
            <section className="py-20 bg-white" data-aos="fade-up" data-aos-duration="1000">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col lg:flex-row items-center">
                        <div className="lg:w-1/2 mb-10 lg:mb-0 lg:pr-10" data-aos="fade-right" data-aos-delay="100" data-aos-duration="1000">
                            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
                                Simple <span className="text-blue-600">Rental Process</span>
                            </h2>
                            <p className="text-lg text-gray-600 mb-8">
                                Renting a car with us is quick and easy with just a few simple steps
                            </p>
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start" data-aos="fade-right" data-aos-delay="300" data-aos-duration="800">
                                    <div className="flex-shrink-0 mt-1">
                                        <div className="w-10 h-10 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold">
                                            2
                                        </div>
                                    ...
                                    <div className="ml-4">
                                        <h3 className="text-lg font-bold text-gray-900">Make Reservation</h3>
                                        <p className="text-gray-600">Book online or call our reservation team</p>
                                    </div>
                                </div>
                                <div className="flex items-start" data-aos="fade-right" data-aos-delay="400" data-aos-duration="800">
                                    <div className="flex-shrink-0 mt-1">
                                        <div className="w-10 h-10 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold">
                                            3
                                        </div>
                                    ...
                                    <div className="ml-4">
                                        <h3 className="text-lg font-bold text-gray-900">Pick Up & Drive</h3>
                                        <p className="text-gray-600">Collect your car and enjoy your trip</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            {/* Locations */}
            <section className="py-20 bg-blue-900 text-white" data-aos="fade-up" data-aos-duration="1000">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16" data-aos="fade-up" data-aos-delay="100">
            ...
            {/* CTA Section */}
            <section className="py-20 bg-yellow-500 text-blue-900" data-aos="fade-up" data-aos-duration="1000">
