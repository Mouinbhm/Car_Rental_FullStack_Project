...
const Contact = () => {
  ...
  const API_URL = "http://localhost:5000/contact/addMessage";
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p
              ...
              data-aos-delay="200"
            >
              We're here to help with any questions about your car rental in
              Tunisia
            </p>
          </div>
        </div>
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <div data-aos="fade-up" data-aos-delay="550">
                    <button
                      type="submit"
                      disabled={submitting}
                      className={`w-full px-6 py-3 text-white font-medium rounded-md transition transform hover:scale-105 shadow-md hover:shadow-lg ${
                        submitting
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div className="ml-4">
                      ...
                      <a
                        href="mailto:contact@tunisia-car-rental.com"
                        className="text-blue-600 hover:underline block mt-2"
                      >
                        contact@tunisia-car-rental.com
                      </a>
                    </div>
                  </div>
              ...
              <div className="divide-y divide-gray-200">
                ...
                >
                  ...
                  <div className="mt-2 text-gray-600">
                    <p>
                      You'll need a valid driver's license (held for at least 2
                      years), a credit card in the main driver's name, and a
                      passport or ID card. International renters may need an
                ...
                >
                  ...
                  <div className="mt-2 text-gray-600">
                    <p>
                      The minimum age is 21 years for economy and compact cars,
                      and 25 years for SUVs and luxury vehicles. Young driver
                      fees may apply for renters under 25.
                    </p>
                  </div>
                </div>
                ...
                >
                  <button className="flex justify-between items-center w-full text-left">
                    <h3 className="text-lg font-medium text-gray-900">
                      Can I pick up the car at one location and return it to
                      another?
                    </h3>
                    <svg
                      className="w-6 h-6 text-blue-600"
                  ...
                  <div className="mt-2 text-gray-600">
                    <p>
                      ...
                      locations in Tunisia. Additional fees may apply depending
                      on the distance between locations.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="mt-2 text-gray-600">
                    <p>
                      ...
                      American Express). Cash payments are accepted at some
                      locations but require a credit card for the security
                      deposit.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="mt-2 text-gray-600">
                    <p>
                      You can cancel or modify your reservation free of charge
                      up to 24 hours before pickup. Late cancellations may incur
                      a fee equivalent to one day's rental.
                    </p>
                  </div>
                </div>
              </div>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p
            ...
            data-aos-delay="200"
          >
            Browse our fleet and reserve your perfect vehicle in just a few
            clicks
          </p>
          <div
