  ...
  const destinations = [
    {
      ...
      description:
        "Explore the vibrant capital with its historic medina, Bardo Museum, and modern city life.",
      recommendedCar: "Hyundai Tucson",
      carCategoryLabel: "SUV",
      carCategorySlug: "suv",
      priceHint: "From 250 TND/day",
    },
    {
      name: "Sousse",
      image:
        "https://t3.ftcdn.net/jpg/00/42/92/74/360_F_42927417_vZFt6VLiMZLU2ZSoz9oGhWxRuS3nGHE2.jpg",
      description:
        "Discover the coastal charm of Sousse with its beaches, souks, and ancient Ribat fortress.",
      recommendedCar: "Volkswagen Golf",
      carCategoryLabel: "Compact",
      carCategorySlug: "compact",
      priceHint: "From 150 TND/day",
    },
    {
      name: "Djerba",
      image:
        "https://t3.ftcdn.net/jpg/06/59/25/30/360_F_659253097_9MWKTOWjBV5oS0Ju9iYbzhC2a2KfIc2W.jpg",
      description:
        "Experience the island’s serene beaches, Djerbahood street art, and traditional markets.",
      recommendedCar: "Toyota Corolla",
      carCategoryLabel: "Midsize",
      carCategorySlug: "midsize",
      priceHint: "From 180 TND/day",
    },
    {
      name: "Sahara Desert",
      image:
        "https://www.discovertunisia.com/en/sites/default/files/oasis2_0.jpg",
      description:
        "Venture into the vast desert for a unique adventure with camel rides and starlit camps.",
      recommendedCar: "Jeep Wrangler",
      carCategoryLabel: "SUV / 4x4",
      carCategorySlug: "suv",
      priceHint: "From 300 TND/day",
    },
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p
              ...
              data-aos-delay="200"
            >
              Explore Tunisia’s top destinations with the perfect rental car for
              your journey
            </p>
            <Link
              to="/cars"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From historic cities to stunning coastlines, find the perfect car
              for your adventure
            </p>
          </div>
                ...
                <div className="p-6">
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    ...
                    <p className="text-gray-600 text-sm">
                      {d.carCategoryLabel} — {d.priceHint}
                    </p>
                    <Link
                      to={`/cars/category/${d.carCategorySlug}`}
                      className="mt-4 inline-block text-blue-600 hover:underline"
                    >
                      View {d.carCategoryLabel} Cars
                    </Link>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 text-center">
                Map out your itinerary to include must-see sites like Carthage,
                El Djem, and Matmata for a seamless road trip.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-gray-600 text-center">
                Take advantage of our affordable rates and consider
                fuel-efficient cars for longer trips to save costs.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-gray-600 text-center">
                Respect local customs, drive cautiously in busy markets, and
